...
exports.resetInternalStates = exports.deletePasscode = exports.hasPasscode = exports.WithBiometryAuthConfig = exports.NoBiometryAuthConfig = exports.getSupportedBiometryType = exports.delay = void 0;
...
exports.hasPasscode = async (serviceName) => {
    return await Keychain.getInternetCredentials(serviceName).then(res => {
        return !!res && !!res.password;
    });
};
exports.deletePasscode = async (serviceName) => {
