...
class InputPasscode extends react_1.PureComponent {
    ...
    renderBottomLeftButton() {
        ...
        return ((0, jsx_runtime_1.jsx)(react_native_1.TouchableWithoutFeedback, Object.assign({ onPress: async () => await this.launchBiometric() }, { children: this.state.biometryType === 'fingerprint' ? ((0, jsx_runtime_1.jsx)(react_native_1.Image, { source: assets_1.Icons.ic_fingerprint, style: {
                    tintColor: commons_1.colors.primary,
                    height: 35,
                    width: 35,
                } })) : ((0, jsx_runtime_1.jsx)(react_native_1.Image, { source: assets_1.Icons.ic_face, style: {
                    tintColor: commons_1.colors.primary,
                    height: 35,
                    width: 35,
                } })) })));
