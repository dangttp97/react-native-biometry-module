...
class Passcode extends react_1.PureComponent {
    ...
    renderTitle() {
        return (react_1.default.createElement(react_native_1.Text, { style: [styles.title, this.props.styleTitle] }, this.props.errorShown ? this.props.titleFail : this.props.title));
    }
            ...
            return (react_1.default.createElement(react_1.default.Fragment, null, ((!this.props.passcodeVisible ||
                (!this.props.passcodeVisible && !lengthSup)) && (react_1.default.createElement(react_native_1.View, { style: [
                    ...
                    !_.isEmpty(this.state.passcode[value])
                        ? {
                            borderColor: (_a = this.props.passcodeHighlightColor) !== null && _a !== void 0 ? _a : commons_1.colors.primary,
                        }
                        : {
                            borderColor: (_b = this.props.passcodeNormalColor) !== null && _b !== void 0 ? _b : commons_1.colors.description,
                        },
                ] },
                react_1.default.createElement(react_native_1.View, { style: [
                        ...
                        !_.isEmpty(this.state.passcode[value])
                            ? {
                                backgroundColor: (_c = this.props.passcodeHighlightColor) !== null && _c !== void 0 ? _c : commons_1.colors.primary,
                            }
                            : {
                                backgroundColor: (_d = this.props.passcodeNormalColor) !== null && _d !== void 0 ? _d : commons_1.colors.transparent,
                            },
                    ] },
                    react_1.default.createElement(react_1.default.Fragment, null))))) || (react_1.default.createElement(react_native_1.View, { style: [styles.passcodeTextCharContainer] },
                ...
                _.isEmpty(this.state.passcode[value]) && (react_1.default.createElement(react_native_1.View, { style: [
                        ...
                        {
                            backgroundColor: (_e = this.props.passcodeNormalColor) !== null && _e !== void 0 ? _e : commons_1.colors.description,
                        },
                    ] }))))));
        })));
    }
