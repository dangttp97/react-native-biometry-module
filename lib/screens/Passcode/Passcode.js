...
class Passcode extends react_1.PureComponent {
    ...
    render() {
        return ((0, jsx_runtime_1.jsxs)(react_native_1.View, Object.assign({ style: [styles.container, this.props.styleContainer] }, { children: [(0, jsx_runtime_1.jsx)(components_1.Typography, { title: this.props.title, description: this.props.subTitle, titleError: this.props.titleFail, descriptionError: this.props.subTitleFail, showError: this.state.showError }), (0, jsx_runtime_1.jsx)(PasscodeIndicator_1.PasscodeIndicator, { passcodeLength: 4, currentPasscode: this.state.passcode, highlightColor: commons_1.colors.primary, normalColor: commons_1.colors.description }), (0, jsx_runtime_1.jsx)(components_1.Keypad, { alphabetCharsVisible: true, disabled: false, deleteButtonDisabled: false, isError: this.state.showError, onEndPasscode: (passcode) => {
                        switch (this.props.type) {
                            case commons_1.PasscodeType.select:
                                if (this.props.validationRegex &&
