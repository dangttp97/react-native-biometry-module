...
class Locked extends react_1.PureComponent {
    ...
    renderLockedScreen() {
        ...
        return ((0, jsx_runtime_1.jsxs)(react_native_1.View, { children: [(0, jsx_runtime_1.jsxs)(react_native_1.View, Object.assign({ style: [styles.textContainer, this.props.styleTextContainer] }, { children: [this.props.titleComponent
                            ? this.props.titleComponent
                            : this.renderTitle(), this.props.timerComponent ? (this.props.timerComponent(minutes, seconds)) : ((0, jsx_runtime_1.jsx)(components_1.CountdownTimer, { lockedTime: this.state.timeDifferent, timePasscodeLockedAsyncStorageName: this.props.timePasscodeLockedAsyncStorageName, passcodeAttemptsAsyncStorageName: this.props.passcodeAttemptsAsyncStorageName })), this.props.iconComponent
