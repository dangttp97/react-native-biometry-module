...
class ChangePasscode extends react_1.PureComponent {
    ...
    render() {
        ...
        return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [this.props.cancelButton ? (this.props.cancelButton) : ((0, jsx_runtime_1.jsx)(react_native_1.TouchableOpacity, Object.assign({ onPress: () => this.handleCancel(), style: [
                        styles.cancelButton,
