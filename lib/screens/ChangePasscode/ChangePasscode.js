...
class ChangePasscode extends react_1.PureComponent {
    ...
    async endProcessInputOldPasscode(passcode) {
        if (passcode === this.state.oldPasscode) {
            ...
            await commons_1.deletePasscode(this.props.passcodeKeychainName);
            await commons_1.deletePasscode(this.props.passcodeKeychainName + 'Biometry');
        }
    }
    ...
    render() {
        ...
        return (<>
        {this.props.cancelButton ? (this.props.cancelButton) : (<react_native_1.TouchableOpacity onPress={() => this.handleCancel()} style={[
            styles.cancelButton,
        ...
        {this.state.type === commons_1.PasscodeType.inputOldPasscode && (<Passcode_1.Passcode {...this.props} type={commons_1.PasscodeType.input} title={(_a = this.props.oldPasscodeTitle) !== null && _a !== void 0 ? _a : 'Enter Your Old PIN Code'} subTitle={this.props.oldPasscodeSubtitle} titleFail={(_b = this.props.oldPasscodeErrorTitle) !== null && _b !== void 0 ? _b : 'Your entries did not match'} subTitleFail={(_c = this.props.oldPasscodeErrorSubtitle) !== null && _c !== void 0 ? _c : 'Please try again'} previousPasscode={this.state.oldPasscode} endProcess={(passcode) => {
            this.endProcessInputOldPasscode(passcode);
        }} styleContainer={styles.passcodeContainer}/>)}
        {this.state.type === commons_1.PasscodeType.selectNewPasscode && (<SelectPasscode_1.SelectPasscode {...this.props} validationRegex={this.props.newPasscodeValidator} selectTitle={(_d = this.props.newPasscodeSelectTitle) !== null && _d !== void 0 ? _d : 'Enter Your New PIN Code'} selectSubtitle={(_e = this.props.newPasscodeSelectSubtitle) !== null && _e !== void 0 ? _e : ''} confirmTitle={(_f = this.props.newPasscodeConfirmTitle) !== null && _f !== void 0 ? _f : 'Verify Your New PIN Code'} confirmSubtitle={(_g = this.props.newPasscodeConfirmSubtitle) !== null && _g !== void 0 ? _g : ''} selectErrorSubtitle={(_h = this.props.newPasscodeSelectErrorTitle) !== null && _h !== void 0 ? _h : ''} confirmErrorSubtitle={this.props.newPasscodeConfirmErrorSubtitle} onSuccess={this.endProcessSelectNewPasscode} styleTitle={this.props.styleSelectNewPasscodeTitle} styleSubTitle={this.props.styleSelectNewPasscodeSubtitle} styleContainer={styles.passcodeContainer}/>)}
      </>);
    }
}
