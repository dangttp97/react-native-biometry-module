...
class Typography extends react_1.default.PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            isError: false,
