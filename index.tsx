...
export class Biometry extends PureComponent<BiometryProps, BiometryState> {
...
export function hasUserSetPasscode(serviceName?: string) {
  return hasPinCode(serviceName || passcodeKeychainNameDefault)
}

export function deleteUserPasscode(serviceName?: string) {
  return deletePinCode(serviceName || passcodeKeychainNameDefault)
}

export function resetPasscodeInternalStates(
